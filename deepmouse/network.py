...
class Layer:
    def __init__(self, name, m, width, height, offset):
        """
        :param name:
        :param m: number of feature maps
        :param width: layer width in pixels
        :param height: layer height in pixels
        :param offset: (horizontal, vertical) offset in pixels from full visual field
            to visual field of this layer
        """
        self.name = name
        self.m = m
        self.width = width
...
class Connection:
    def __init__(self, pre, post, s, w, density_peak, density_width):
        """
        :param pre: input layer
        :param post: output layer
        :param s: stride
        :param w: width of square kernel
        :param density_peak: connection density (fraction non-zero elements) at centre of kernel
        :param density_width: width of Gaussian connection density profile (pixels)
        """
        self.pre = pre
        self.post = post
        self.s = s
