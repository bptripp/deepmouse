...
def propagate_through_isocortex(vectors, data_folder='data_files/', ignore_zero_vectors=False):
    """
...
def get_probe_area_vector_corr():
    ...
    for area in probe_areas:
        ...
        print('{} of {} vectors with zeros'.format(len(vectors_with_zeros), vectors.shape[0]))
